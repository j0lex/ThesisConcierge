...
public final class FragmentDashboardBinding implements ViewBinding {
  ...
  @NonNull
  public final GridLayout professorButtonGrid;
  ...
  private FragmentDashboardBinding(@NonNull ConstraintLayout rootView,
      @NonNull GridLayout professorButtonGrid, @NonNull SearchView searchView,
      @NonNull TextView textDashboard) {
    this.rootView = rootView;
    this.professorButtonGrid = professorButtonGrid;
  ...
  public static FragmentDashboardBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.professor_button_grid;
      GridLayout professorButtonGrid = ViewBindings.findChildViewById(rootView, id);
      if (professorButtonGrid == null) {
        break missingId;
      }
      ...
      return new FragmentDashboardBinding((ConstraintLayout) rootView, professorButtonGrid,
          searchView, textDashboard);
    }
